...
const ConverterForm = () => {
    ...
    const getExchangeRate = async () => {
        ...
        const API_URL = `https://v6.exchangerate-api.com/v6/6a1f69b79411634f142022e2/pair/${fromCurrency}/${toCurrency}`;
  ...
  return (
    <form className="converter-form" onSubmit={handleFromSubmit}>
            ...
            <div className="form-group form-currency-group">
                ...
                <p className="exchange-rate-result">{isLoading ? "Fetching Exchange Rates.." : result}</p>
        </form>
  )
}
